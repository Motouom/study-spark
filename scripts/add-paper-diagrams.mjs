...
const diagrams = {
  ...
  "physics-inclined-plane.svg": svgShell(
  ...
  "chemistry-titration.svg": svgShell(
    "Titration apparatus",
    `
  ...
  "biology-heart.svg": svgShell(
    "Human heart schematic",
    `
  ...
  "geography-contours.svg": svgShell(
    "Contour map extract",
    `
  ...
  "geography-climograph.svg": svgShell(
    "Climograph",
    `
  ...
  ${[
    ...
    .map(
      ([x, y, t]) =>
        `<rect class="fill" x="${x}" y="${y}" width="115" height="62" rx="8"/><text x="${x + 28}" y="${y + 38}">${t}</text><line class="line" x1="${x + 58}" y1="${y + 62}" x2="380" y2="205"/>`,
    )
    .join("")}
  <text x="286" y="282" class="small">Identify devices, IP addressing, and security controls.</text>`,
  ),
  "economics-demand-supply.svg": svgShell(
  ...
  "math-parabola.svg": svgShell(
    "Parabola and inverse sketch axes",
    `
...
const plan = {
  mathematics: [
    ["set-1.md", 10, "math-triangle.svg", "Triangle ABC"],
    ["set-2.md", 8, "math-parabola.svg", "Graph sketch axes"],
    ["set-3.md", 13, "math-argand.svg", "Argand diagram"],
  ],
  "additional-mathematics": [
    ["set-1.md", 10, "math-triangle.svg", "Triangle ABC"],
    ["set-2.md", 24, "math-statistics.svg", "Cumulative frequency curve"],
    ["set-3.md", 8, "math-parabola.svg", "Graph sketch axes"],
  ],
  "further-mathematics": [
    ["set-1.md", 13, "math-argand.svg", "Argand diagram"],
    ["set-2.md", 24, "math-statistics.svg", "Cumulative frequency curve"],
    ["set-3.md", 10, "math-triangle.svg", "Triangle ABC"],
  ],
  ...
  "pure-mathematics-with-statistics": [
    ["set-1.md", 24, "math-statistics.svg", "Cumulative frequency curve"],
    ["set-2.md", 13, "math-argand.svg", "Argand diagram"],
    ["set-3.md", 10, "math-triangle.svg", "Triangle ABC"],
  ],
  physics: [
    ["set-1.md", 2, "physics-circuit.svg", "Circuit diagram"],
    ["set-2.md", 3, "physics-optics.svg", "Convex lens ray diagram"],
    ["set-3.md", 4, "physics-inclined-plane.svg", "Inclined plane force diagram"],
  ],
  chemistry: [
    ["set-1.md", 2, "chemistry-titration.svg", "Titration apparatus"],
    ["set-2.md", 6, "chemistry-cell.svg", "Electrochemical cell"],
    ["set-3.md", 2, "chemistry-titration.svg", "Titration apparatus"],
  ],
  biology: [
    ["set-1.md", 1, "biology-cell.svg", "Plant cell diagram"],
    ["set-2.md", 6, "biology-heart.svg", "Human heart diagram"],
    ["set-3.md", 1, "biology-cell.svg", "Plant cell diagram"],
  ],
  "human-biology": [
    ["set-1.md", 1, "biology-heart.svg", "Human heart diagram"],
    ["set-2.md", 2, "biology-cell.svg", "Cell diagram"],
    ["set-3.md", 6, "biology-heart.svg", "Human heart diagram"],
  ],
  geography: [
    ["set-1.md", 1, "geography-contours.svg", "Contour map extract"],
    ["set-2.md", 2, "geography-climograph.svg", "Climograph"],
    ["set-3.md", 1, "geography-contours.svg", "Contour map extract"],
  ],
  geology: [
    ["set-1.md", 1, "geology-section.svg", "Geological cross-section"],
    ["set-2.md", 4, "geology-section.svg", "Geological cross-section"],
    ["set-3.md", 8, "geology-section.svg", "Geological cross-section"],
  ],
  "agricultural-science": [
    ["set-1.md", 1, "agriculture-soil.svg", "Soil profile"],
    ["set-2.md", 1, "agriculture-soil.svg", "Soil profile"],
    ["set-3.md", 1, "agriculture-soil.svg", "Soil profile"],
  ],
  "computer-science": [
    ["set-1.md", 2, "computer-network.svg", "Computer network topology"],
    ["set-2.md", 3, "computer-network.svg", "Computer network topology"],
    ["set-3.md", 2, "computer-network.svg", "Computer network topology"],
  ],
  ict: [
    ["set-1.md", 2, "computer-network.svg", "Computer network topology"],
    ["set-2.md", 3, "computer-network.svg", "Computer network topology"],
  ...
  economics: [
    ["set-1.md", 1, "economics-demand-supply.svg", "Demand and supply graph"],
    ["set-2.md", 5, "economics-demand-supply.svg", "Demand and supply graph"],
    ["set-3.md", 1, "economics-demand-supply.svg", "Demand and supply graph"],
  ],
  commerce: [
    ["set-1.md", 4, "economics-demand-supply.svg", "Market graph"],
    ["set-2.md", 4, "economics-demand-supply.svg", "Market graph"],
    ["set-3.md", 4, "economics-demand-supply.svg", "Market graph"],
  ],
  "business-studies": [
    ["set-1.md", 3, "economics-demand-supply.svg", "Business market graph"],
    ["set-2.md", 3, "economics-demand-supply.svg", "Business market graph"],
    ["set-3.md", 3, "economics-demand-supply.svg", "Business market graph"],
  ],
  "food-and-nutrition": [
    ["set-1.md", 1, "food-plate.svg", "Balanced diet plate"],
    ["set-2.md", 1, "food-plate.svg", "Balanced diet plate"],
    ["set-3.md", 1, "food-plate.svg", "Balanced diet plate"],
  ],
...
console.log(
  `Wrote ${Object.keys(diagrams).length} diagram assets and updated ${updated} paper files.`,
);
