...
-- Free learners can inspect one complete matching item in every subject and
-- content section. Premium learners retain access to every matching item.
...
begin
  ...
  return query
    ...
    select
      ...
      document.series,
      case
        when document.premium_active or document.access_position = 1
      ...
      case
        ...
        when document.access_position = 1 then 'free_preview'
        else 'premium_locked'
      end as access_status,
      not (document.premium_active or document.access_position = 1) as is_locked
