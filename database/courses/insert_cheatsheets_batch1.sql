...
values ('cheat-math-number-and-operations', 'Mathematics', 'Number & Operations Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-math-algebra-and-equations', 'Mathematics', 'Algebra & Equations Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-math-geometry-and-mensuration', 'Mathematics', 'Geometry & Mensuration Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ANGLE FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-math-trigonometry', 'Mathematics', 'Trigonometry Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-math-statistics-and-probability', 'Mathematics', 'Statistics & Probability Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-eng-comprehension', 'English Language', 'Comprehension Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'QUESTION TYPES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-eng-summary-writing', 'English Language', 'Summary Writing Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE 5-STEP METHOD
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-eng-grammar-essentials', 'English Language', 'Grammar Essentials Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CONCORD (agreement)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-eng-composition-and-letters', 'English Language', 'Composition & Letters Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THREE TYPES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-measurement', 'Physics', 'Measurement Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'BASE UNITS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-mechanics', 'Physics', 'Mechanics Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY EQUATIONS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-thermal-physics', 'Physics', 'Thermal Physics Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-waves-and-light', 'Physics', 'Waves & Light Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'WAVE FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-electricity', 'Physics', 'Electricity Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CIRCUIT FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-magnetism-and-induction', 'Physics', 'Magnetism & Induction Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'MAGNET BASICS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-phys-radioactivity', 'Physics', 'Radioactivity Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'RADIATION TYPES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-atomic-structure', 'Chemistry', 'Atomic Structure Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY FACTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-bonding', 'Chemistry', 'Bonding Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'IONIC
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-the-mole', 'Chemistry', 'The Mole Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE FORMULAS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-acids-bases-and-salts', 'Chemistry', 'Acids, Bases & Salts Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ACIDS (HCl, H₂SO₄, HNO₃)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-electrolysis', 'Chemistry', 'Electrolysis Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'SETUP
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-metals', 'Chemistry', 'Metals Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'REACTIVITY SERIES (memorise!)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-chem-organic-chemistry-intro', 'Chemistry', 'Organic Chemistry Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CRUDE OIL
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-cell-biology', 'Biology', 'Cell Biology Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CELL PARTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-nutrition-and-digestion', 'Biology', 'Nutrition & Digestion Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'DIET
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-transport-systems', 'Biology', 'Transport Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PLANTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-respiration', 'Biology', 'Respiration Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'AEROBIC
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-coordination', 'Biology', 'Coordination Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'NERVOUS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-reproduction-and-genetics', 'Biology', 'Reproduction & Genetics Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'REPRODUCTION
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-bio-ecology', 'Biology', 'Ecology Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY TERMS
