...
values ('cheat-econ-basic-concepts', 'Economics', 'Basic Economic Concepts Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CORE IDEAS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-econ-demand-and-supply', 'Economics', 'Demand & Supply Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'DEMAND
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-econ-elasticity', 'Economics', 'Elasticity Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'FORMULA
PED = %ΔQ demanded ÷ %ΔP.
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-econ-production-and-money', 'Economics', 'Production & Money Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PRODUCTION
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-econ-trade', 'Economics', 'Trade Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'KEY TERMS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-comm-home-trade', 'Commerce', 'Home Trade Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'RETAILERS (sell to consumers)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-comm-business-units', 'Commerce', 'Business Units Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'FORMS OF OWNERSHIP
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-comm-aids-to-trade', 'Commerce', 'Aids to Trade Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'TRANSPORT
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-comm-business-documents', 'Commerce', 'Business Documents Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE ORDER (memorise!)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-cs-data-representation', 'Computer Science', 'Data Representation Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'BINARY
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-cs-programming-and-algorithms', 'Computer Science', 'Programming Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ALGORITHM
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-cs-databases', 'Computer Science', 'Databases Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'STRUCTURE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-cs-networks-and-internet', 'Computer Science', 'Networks & Internet Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'NETWORKS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-ict-office-applications', 'ICT', 'Office Applications Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'WORD PROCESSOR
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-ict-internet-and-safety', 'ICT', 'Internet & Safety Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'INTERNET
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fr-grammaire', 'French', 'Grammaire Cheatsheet', 'french', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ACCORDS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fr-conjugaison', 'French', 'Conjugaison Cheatsheet', 'french', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PRÉSENT (1er groupe)
-e, -es, -e, -ons, -ez, -ent.
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fr-compr-hension-et-composition', 'French', 'Compréhension & Composition Cheatsheet', 'french', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'COMPRÉHENSION
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hist-cameroon-before-1884', 'History', 'Cameroon Before 1884 Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PEOPLES & MIGRATIONS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hist-colonial-rule', 'History', 'Colonial Rule Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'GERMAN RULE (1884–1916)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hist-independence-and-reunification', 'History', 'Independence & Reunification Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'UPC (1948)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hist-african-nationalism', 'History', 'African Nationalism Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CAUSES (after 1945)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hist-world-wars', 'History', 'World Wars Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'WWI (1914–18)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geo-landforms', 'Geography', 'Landforms Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'EARTH & ROCKS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geo-climate', 'Geography', 'Climate Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'INSTRUMENTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geo-population-and-settlement', 'Geography', 'Population Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'DISTRIBUTION
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geo-economic-activities', 'Geography', 'Economic Activities Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'AGRICULTURE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geo-map-work', 'Geography', 'Map Work Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'SCALE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-civ-rights-and-duties', 'Citizenship Education', 'Rights & Duties Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CITIZENSHIP
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-civ-state-institutions', 'Citizenship Education', 'State Institutions Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE REPUBLIC
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-rel-old-testament', 'Religious Studies', 'Old Testament Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'STRUCTURE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-rel-new-testament', 'Religious Studies', 'New Testament Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'GOSPELS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-rel-christian-life-today', 'Religious Studies', 'Christian Life Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'MORAL APPLICATIONS (teaching → scripture → situation → response)
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-log-syllogisms', 'Logic', 'Syllogisms Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'BASICS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-log-fallacies', 'Logic', 'Fallacies Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'FORMAL
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-agr-soils', 'Agricultural Science', 'Soils Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PROFILE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-agr-crop-production', 'Agricultural Science', 'Crop Production Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PRINCIPLES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-agr-animal-production', 'Agricultural Science', 'Animal Production Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'POULTRY
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hbio-body-systems', 'Human Biology', 'Body Systems Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ORGANISATION
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hbio-blood-and-circulation', 'Human Biology', 'Blood & Circulation Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'BLOOD
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-hbio-reproduction-and-health', 'Human Biology', 'Reproduction & Health Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'SYSTEMS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-amath-factor-theorem', 'Additional Mathematics', 'Factor Theorem Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THEOREMS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-amath-differentiation', 'Additional Mathematics', 'Differentiation Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'STANDARD RESULTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-amath-integration', 'Additional Mathematics', 'Integration Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'STANDARD INTEGRALS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fnut-nutrients', 'Food and Nutrition', 'Nutrients Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'ENERGY VALUES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fnut-meal-planning', 'Food and Nutrition', 'Meal Planning Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PLANNING FACTORS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-fnut-preservation-and-hygiene', 'Food and Nutrition', 'Preservation & Hygiene Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'SPOILAGE CAUSES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-lit-literary-terms', 'English Literature', 'Literary Terms Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PLOT & STRUCTURE
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-lit-prose-and-drama', 'English Literature', 'Prose & Drama Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'PROSE QUESTIONS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-acct-double-entry', 'Accounting', 'Double Entry Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE RULES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-acct-final-accounts', 'Accounting', 'Final Accounts Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'INCOME STATEMENT
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-acct-control-and-reconciliation', 'Accounting', 'Control Accounts Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CONTROL ACCOUNTS
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-biz-business-types', 'Business Studies', 'Business Types Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'OWNERSHIP
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-biz-marketing', 'Business Studies', 'Marketing Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'THE 4Ps
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-biz-finance', 'Business Studies', 'Business Finance Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'SOURCES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geol-minerals-and-rocks', 'Geology', 'Minerals & Rocks Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'MINERAL ID
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geol-volcanism-and-hazards', 'Geology', 'Volcanism Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'VOLCANO TYPES
...
insert into public.course_documents (topic_id, subject, title, language, level, class_levels, series, status, doc_type, markdown_content)
values ('cheat-geol-economic-geology', 'Geology', 'Economic Geology Cheatsheet', 'english', 'ordinary', array['form_3','form_4','form_5']::text[], array['general','science','arts','commercial','technical']::text[], 'published', 'cheatsheet', 'CAMEROON RESOURCES (learn + locate!)
