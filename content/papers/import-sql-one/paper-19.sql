...
with chosen_topic as (
  ...
  select id from public.course_documents where title = 'CAMEROON GCE ADVANCED LEVEL HISTORY P2 SET 2' limit 1
)
...
values (coalesce((select id from existing), gen_random_uuid()), (select id from chosen_topic), 'History', 'CAMEROON GCE ADVANCED LEVEL HISTORY P2 SET 2', 'english', 'advanced', array['form_3', 'form_4', 'form_5', 'lower_sixth', 'upper_sixth']::text[], array['general', 'science', 'arts', 'commercial', 'technical', 'a_science', 'a_arts', 'a_commercial', 'a_technical']::text[], 'published', '# CAMEROON GCE ADVANCED LEVEL HISTORY P2 SET 2
