...
with chosen_topic as (
  ...
  select id from public.course_documents where title = 'CAMEROON GCE ORDINARY LEVEL ICT P2 SET 3' limit 1
)
insert into public.course_documents (
  ...
  'ICT', 'CAMEROON GCE ORDINARY LEVEL ICT P2 SET 3', 'english', 'ordinary',
  array['form_3', 'form_4', 'form_5', 'lower_sixth', 'upper_sixth']::text[],
  array['general', 'science', 'arts', 'commercial', 'technical', 'a_science', 'a_arts', 'a_commercial', 'a_technical']::text[],
  'published', '# CAMEROON GCE ORDINARY LEVEL ICT P2 SET 3
...
with chosen_topic as (
  ...
  select id from public.course_documents where title = 'CAMEROON GCE ORDINARY LEVEL FOOD AND NUTRITION P2 SET 1' limit 1
)
insert into public.course_documents (
  id, topic_id, subject, title, language, level, class_levels, series, status, markdown_content, created_by
) values (
  coalesce((select id from existing), gen_random_uuid()),
  (select id from chosen_topic),
  'Food and Nutrition', 'CAMEROON GCE ORDINARY LEVEL FOOD AND NUTRITION P2 SET 1', 'english', 'ordinary',
  array['form_3', 'form_4', 'form_5', 'lower_sixth', 'upper_sixth']::text[],
  array['general', 'science', 'arts', 'commercial', 'technical', 'a_science', 'a_arts', 'a_commercial', 'a_technical']::text[],
  'published', '# CAMEROON GCE ORDINARY LEVEL FOOD AND NUTRITION P2 SET 1
