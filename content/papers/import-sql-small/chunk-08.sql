...
with chosen_topic as (
  ...
  select id from public.course_documents where title = 'CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 1' limit 1
)
insert into public.course_documents (
  ...
  'Geography', 'CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 1', 'english', 'advanced',
  array['form_3', 'form_4', 'form_5', 'lower_sixth', 'upper_sixth']::text[],
  array['general', 'science', 'arts', 'commercial', 'technical', 'a_science', 'a_arts', 'a_commercial', 'a_technical']::text[],
  'published', '# CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 1
...
with chosen_topic as (
  ...
  select id from public.course_documents where title = 'CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 2' limit 1
)
insert into public.course_documents (
  id, topic_id, subject, title, language, level, class_levels, series, status, markdown_content, created_by
) values (
  coalesce((select id from existing), gen_random_uuid()),
  (select id from chosen_topic),
  'Geography', 'CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 2', 'english', 'advanced',
  array['form_3', 'form_4', 'form_5', 'lower_sixth', 'upper_sixth']::text[],
  array['general', 'science', 'arts', 'commercial', 'technical', 'a_science', 'a_arts', 'a_commercial', 'a_technical']::text[],
  'published', '# CAMEROON GCE ADVANCED LEVEL GEOGRAPHY P2 SET 2
