-- Update leaderboard to include education_system and support filtering by it.
-- This separates GCE English and Francophone learners on the leaderboard.
...
as $$
  ...
  learner_rows as (
    select
      ...
      coalesce(profile.education_system, 'gce') as education_system,
      profile.level,
      profile.class_level,
      profile.series,
