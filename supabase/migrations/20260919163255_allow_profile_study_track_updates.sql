-- Allow learners to correct their study profile after progress exists.
-- Progress records remain attached to their original papers/documents, but
-- the active profile should reflect the learner's actual class, series, and subjects.
