        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          {myRank > 0 && (
            <p className="mt-3 text-sm text-muted-foreground">
              You are ranked <span className="font-medium text-foreground">#{myRank}</span> in this
              view.
            </p>
          )}
        </div>
              ...
              {filteredRows.map((row, index) => (
                ...
                >
                  ...
                  <span>
                    ...
                    <span className="text-xs text-muted-foreground">{seriesLabel(row.series)}</span>
                  </span>
        ...
        {!loading && filteredRows.length === 0 && (
          <div className="rounded-xl border border-dashed border-border bg-card p-12 text-center">
            ...
            <p className="mx-auto mt-1 max-w-md text-sm text-muted-foreground">
              Leaderboards are calculated from real structural paper marks by level. Learners appear
              after they mark questions as started, passed, or failed. Set your region and city in
              Settings to join local rankings.
            </p>
